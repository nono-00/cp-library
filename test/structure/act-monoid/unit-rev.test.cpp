...
using Base = nono::act_monoid::RangeAffineRangeSum<Mint>;
using Monoid = nono::act_monoid::Rev<Base>;
using BaseValue = Base::Value;
using Value = Monoid::Value;
using Act = Monoid::Act;

bool operator==(BaseValue lhs, BaseValue rhs) {
