...
//  ///  # lower bound(root, key)
//  ///  return min { x | !(x < key) } node
//  ///  if not exist, return nullptr
//  ///  O(log n)
//  template <class T>
//  NodePtr<T> lower_bound(NodePtr<T> root, T key) {
...
//  }
//
//  ///  # upper bound(root, key)
//  ///  return min { x | key < x } node
//  ///  if not exist, return nullptr
//  ///  O(log n)
//  template <class T>
//  NodePtr<T> upper_bound(NodePtr<T> root, T key) {
//     NodePtr<T> result = nullptr;
//     while (!root) {
